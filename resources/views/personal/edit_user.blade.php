...
@section('title', 'ユーザー情報更新ページ|Developer-Meets')
@section('contents')
@if($errors->any())
    <div class="error">
...
@endif
  <dl class="my_infomations">
    ...
    {{Form::open(['route' => 'edit_profile_post', 'method' => 'post','files'=> true, 'enctype' => 'multipart/form-data', 'style' => 'width:100%;'])}}
        ...
        <dt>プロフィール</dt>
        <dd>{{Form::textarea('self_introduction', $login_user_infomation->self_introduction, ['class' => 'form-control', 'id' => 'edit_self_introduction', 'rows' => '3'])}}</dd>
